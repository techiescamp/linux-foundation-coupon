...
## [58% OFF] Linux Foundation May Skills Sale [Expired]

Get up to 58% discount at part of this exclusive May Skills sale.

> [!IMPORTANT]
>**Coupon:** Use code **MAY25CT** at [kube.promo/devops](https://kube.promo/devops) to get 40% on individual certifications.

To get more than 58% discount, you can use the certifications bundles.

> [!IMPORTANT]
>**Coupon:** Use code **MAY25BUNCT** with the the follwing bundles
